...
ApplicationWindow {
    ...
    VideoCaptureHandler{
        id:videoCaptureHandler
    }
    AudioCaptureHandler{
        id:audioCaptureHandler
    }
    Connections {
        target: dataManagerId
        onFileSaved: {
            modelView.refresh() // Assuming `modelView` is the ID of your FolderListModel
        }
    }
    ...
    Rectangle {
        ...
        Rectangle {
                ...
                Item {
                    ...
                    Button {
                        ...
                        onClicked:{
                            ...
                            if(videoRadio.checked){
                                // camera.active = true
                                videoCaptureHandler.startVideoCapture()
                                stackView.push(cameraRect)
                            }
                            if(audioRadio.checked){
                                audioCaptureHandler.startAudioCapture()
                    ...
                    Button {
                        ...
                        onClicked:{
                            ...
                            if(videoRadio.checked){
                                videoCaptureHandler.stopVideoCapture()
                                let videoData = videoCaptureHandler.getVideoData()
                                let videoFileName = "recordedVideo.mp4"
                                datamangerId.saveFile(videoData, videoFileName)

                            }
                            else if(audioRadio.checked){
                                audioCaptureHandler.stopAudioCapture()
                                let audioData = audioCaptureHandler.getAudioData()
                                let audioFileName = "recordedAudio.wav"
                                datamangerId.saveFile(audioData, audioFileName)
                            }
                            modelView.folder=modelView.folder
                        }
            ...
            Rectangle{
                ...
                Rectangle {
                    id: cameraRect
                    // Video capture logic is now in C++
                    VideoOutput {
                        id: camVideoOutput
                        anchors.fill: parent
                        fillMode: VideoOutput.Stretch
                ...
                ScrollView {
                    ...
                    ListView {
                        ...
                        model:FolderListModel{
                            id:modelView
                            folder:"file:///C:/QML Projects/recorderOpenCV/recordedFiles/"
                            ...
                            Button {
                                ...
                                onClicked: {
                                    ...
                                    if (model.fileName.endsWith(".mp4") || model.fileName.endsWith(".avi") || model.fileName.endsWith(".mkv")) {
                                        ...
                                        mediaPlayer.source = modelView.folder + "recordedVideo.mp4"
                                        stackView.clear()
                                        ...
                                        // Play audio
                                        audioPlayerText.text = fileName1
                                        audiomediaPlayer.source = "file:///C:/QML Projects/recorderOpenCV/recordedFiles/" + fileName1
                                        stackView.clear()
