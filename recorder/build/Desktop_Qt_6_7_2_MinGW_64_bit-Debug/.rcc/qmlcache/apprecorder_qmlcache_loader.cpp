...
namespace _qt_qml_recorder_Main_qml { 
...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/recorder/Main.qml"), &QmlCacheGeneratedCode::_qt_qml_recorder_Main_qml::unit);
